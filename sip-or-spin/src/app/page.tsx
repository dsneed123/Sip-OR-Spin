    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20"
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start bg-black text-white">
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          <a className="rounded-full border border-transparent transition-colors flex items-center justify-center bg-[#383838] text-white hover:bg-[#555] text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5" href="/explore">
            How to play
          </a>
