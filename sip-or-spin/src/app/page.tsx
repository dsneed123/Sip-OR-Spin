    ...
    >
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start bg-black text-white">
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          <a
            className="rounded-full border border-transparent transition-colors flex items-center justify-center bg-[#383838] text-white hover:bg-[#555] text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5"
            href="/explore"
          >
            How to play
          </a>
          <a
            className="rounded-full border border-solid border-black/[.08] dark:border-white/[.145] transition-colors flex items-center justify-center bg-[#f2f2f2] text-black hover:bg-[#e0e0e0] hover:border-transparent text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:min-w-44"
            href="/spin"
          >
            Spin the Wheel
          </a>
